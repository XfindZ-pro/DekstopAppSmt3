...
Public Class ReportKeuangan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApp1.ReportKeuangan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TotalKasTokoParameter() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReportKeuangan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportKeuangan = New ReportKeuangan()
        rpt.Site = Me.Site
        Return rpt
    End Function
